...
import { closeImage, openImage } from '../Zoom image/zoomimage'
    ...
    return (
        <div>
                    ...
                    <tbody>
                        {arr?.map((x, i) => {
                            return <tr key={i + 1}>
                                <td>{i + 1}</td>
                                <td>
                                    <img src={x.image} alt="" width={40} height={40} onClick={() => openImage(x.image)} />
                                </td>
                                <td>{x.firstName}</td>
                                <td>{x.lastName}</td>
                                <td>{x.age}</td>
            ...
            <div className="zoom_image">
                <button className='btn btn-close' onClick={closeImage}></button>
